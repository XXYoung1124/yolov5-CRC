...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'panel-2/data.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/2/CTR3/CTR3+转置卷积+EIOU(0.858,0.889,0.913;0.887)/weights/best.pt', help='model.pt path(s)')
